...
<style>
  ...
  <div class="foot">Generated by BizData analytics. Observed figures are provider-reported; assessed figures are estimates. Paid figures are sourced from the Tax app where available. PII is masked unless the viewer is authorised.</div>
</body></html>`;
}
