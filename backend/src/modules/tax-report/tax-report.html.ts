...
export function renderTaxReportHtml(r: any): string {
  const t = r.taxpayer;
...
<style>
  ...
  <p class="muted">Kano State Internal Revenue Service · generated ${esc(new Date(r.generatedAt).toLocaleString())}</p>
  ...
  <div class="foot">Generated by FinData analytics. Observed figures are provider-reported; assessed figures are estimates. Paid figures are sourced from the Tax app where available. PII is masked unless the viewer is authorised.</div>
</body></html>`;
}
