...
import { declaredIncomeApi } from '@/lib/api/declared-income';
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      <PageHeader
        ...
        subtitle="Bulk-upload declarations to compare against ingested provider data."
...
taxpayernin,taxpayercacrcnumber,year,assessableincome,source,notes
</pre>
        <p className="text-xs text-slate-500 mt-2">
          At least one of <code>taxpayernin</code> or <code>taxpayercacrcnumber</code> is required so the row can be matched to an existing taxpayer.
        </p>
      </div>
