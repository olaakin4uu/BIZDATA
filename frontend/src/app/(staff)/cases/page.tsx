...
export default function CasesListPage() {
  ...
  useEffect(() => {
    setCases(null);
    casesApi
      .list({ status: status || undefined, riskLevel: riskLevel || undefined, sort: 'estimatedTaxDue', limit: 100 })
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-5">
        ...
        {cases && <span className="text-xs text-slate-400">{total} case{total === 1 ? '' : 's'}</span>}
      </div>
